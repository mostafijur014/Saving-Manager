...
export const AdminDashboard = () => {
  ...
  useEffect(() => {
    if (settings) {
      setSettingsForm({
        ...
        showGrowthChart: settings.showGrowthChart !== undefined ? settings.showGrowthChart : true,
        showPublicGrowthChart: settings.showPublicGrowthChart !== undefined ? settings.showPublicGrowthChart : true
      });
    }
  }, [settings]);
  ...
  const handleUpdateSettings = async () => {
    try {
      ...
      const data = {
        ...
        showGrowthChart: settingsForm.showGrowthChart,
        showPublicGrowthChart: settingsForm.showPublicGrowthChart,
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 dashboard-root">
                    ...
                    <label className="flex items-center gap-3 cursor-pointer group">
                      <div className="relative inline-flex items-center cursor-pointer">
                        <input 
                          type="checkbox" 
                          className="sr-only peer"
                          checked={settingsForm.showGrowthChart}
                          onChange={(e) => setSettingsForm({...settingsForm, showGrowthChart: e.target.checked})}
                        />
                        <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-indigo-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-indigo-600"></div>
                      </div>
                      <span className="text-sm font-medium text-gray-700 group-hover:text-indigo-600 transition-colors">Show Monthly Collection Growth Chart (Admin)</span>
                    </label>
                  </div>
                    ...
                    <label className="flex items-center gap-3 cursor-pointer group">
                      <div className="relative inline-flex items-center cursor-pointer">
                        <input 
                          type="checkbox" 
                          className="sr-only peer"
                          checked={settingsForm.showPublicGrowthChart}
                          onChange={(e) => setSettingsForm({...settingsForm, showPublicGrowthChart: e.target.checked})}
                        />
                        <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-indigo-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-indigo-600"></div>
                      </div>
                      <span className="text-sm font-medium text-gray-700 group-hover:text-indigo-600 transition-colors">Show Monthly Collection Growth Chart (Public)</span>
                    </label>
                  </div>
                </div>
              </motion.div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 mb-8 overflow-hidden">
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            {expandedSections.expenses ? <ChevronUp className="w-5 h-5 text-gray-400" /> : <ChevronDown className="w-5 h-5 text-gray-400" />}
          </div>
        </div>
      ...
      {/* Stats and Chart */}
      {settings.showGrowthChart !== false && (
      ...
      {/* Alternative Stats when chart is hidden */}
      {settings.showGrowthChart === false && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="bg-indigo-600 p-6 rounded-2xl text-white shadow-lg shadow-indigo-200 flex justify-between items-center">
            <div>
              <p className="text-indigo-100 text-sm font-medium">Total Final Balance</p>
              <h4 className="text-3xl font-bold mt-1">{formatCurrency(totalFinal)}</h4>
            </div>
            <div className="text-right space-y-1 text-sm">
              ...
              <div className="flex justify-between items-center gap-4 text-red-200">
                <span>Total Expenses</span>
                <span className="font-bold">-{formatCurrency(totalExpenses)}</span>
              </div>
            </div>
